...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/zerorecoil)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/zerorecoil
```

A live public deployment of this template is available at [https://zerorecoil.templates.workers.dev](https://zerorecoil.templates.workers.dev)
